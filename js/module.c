    ...
    for (size_t i = 0; i < arraylen; ++i) {
        ...
        if (valuetype == napi_undefined || valuetype == napi_null) {
            ...
            if (!strcmp(column_type, "u32")) {
                ...
                napi_create_error2(env, "Schema type is not u32/u64", &self->error);
                return NULL;
            }
...
napi_value f_schema2_create(napi_env env, napi_callback_info info) {
    ...
    napi_value retval;
    napi_create_int64(env, rc, &retval);
    return retval;
}
...
napi_value f_schema2_len(napi_env env, napi_callback_info info) {
    ...
    napi_value retval;
    napi_create_int64(env, len, &retval);
    return retval;
}
...
napi_value f_schema2_get_column_name(napi_env env, napi_callback_info info) {
    ...
    int column_index = -1;
    status = napi_get_value_int32(env, argv[0], &column_index);
    if (status != napi_ok) {
...
napi_value f_schema2_get_column_nullable(napi_env env, napi_callback_info info) {
    ...
    napi_value retval;
    napi_create_int64(env, is_nullable, &retval);
    return retval;
}
...
napi_value f_schema2_add_column(napi_env env, napi_callback_info info) {
    ...
    napi_value retval;
    napi_create_int64(env, 0, &retval);
    return retval;
}
...
napi_value f_writef_create(napi_env env, napi_callback_info info) {
    ...
    napi_value retval;
    napi_create_int64(env, whandle, &retval);
    return retval;
